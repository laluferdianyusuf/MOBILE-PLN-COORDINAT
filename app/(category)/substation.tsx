                ...
                <View className="flex-1">
                  <View className="mb-4 p-4 bg-amber-50 rounded-lg border border-yellow-400">
                    ...
                    <Text className="text-gray-700 mb-1 font-artegra-italic">
                      <Text className="font-artegra-italic">In</Text> = Daya
                      Trafo / (Tegangan TR × √3)
                    </Text>
                    <Text className="text-gray-700 mb-1 font-artegra-italic">
                    ...
                    <Text className="text-gray-700 font-artegra">
                      - <Text className="font-artegra-bold">Daya Trafo</Text>{" "}
                      dalam satuan VA (Volt Ampere)
                    </Text>
                    <Text className="text-gray-700 font-artegra">
                      - <Text className="font-artegra-bold">Tegangan TR</Text>{" "}
                      adalah tegangan sekunder trafo (biasanya 400 V)
                    </Text>
                    <Text className="text-gray-700 font-artegra">
                      -{" "}
                    ...
                    <Text className="text-gray-700 font-artegra">
                      - <Text className="font-artegra-bold">Faktor 0.9</Text>{" "}
                      adalah asumsi beban 90% dari trafo
                    </Text>
                  </View>
                  <CustomInput
                    title="Masukkan Daya"
                  ...
                  {result !== null && (
                    <View className="bg-gray-200 p-4 rounded-lg border border-gray-400 my-6 space-y-3">
                      ...
                      <View className="mt-3 space-y-1">
                        ...
                        <Text className="text-sm text-gray-600 font-artegra">
                          6. NH Fuse = Arus per Jurusan × 0.9 ={" "}
                          {result.toFixed(2)} A
                        </Text>
                      </View>

                      <Text className="text-xs text-gray-500 font-artegra-italic mt-2">
                        NH Fuse ini mewakili 90% dari beban arus tiap jurusan
                        gardu, yang dihitung dari daya total dan jumlah jurusan.
                      </Text>
                    </View>
                  )}
                </View>
